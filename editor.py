...
class Editor:
    def __init__(self):
        ...
        # convention bcuz screen is window, display is what you render onto, black image, render onto smaller resolution then scale it up to get pixel art
    ...
    def run(self):
        ...
        while True:
            ...
            if self.clicking and self.ongrid:
                self.tilemap.tilemap[str(tile_pos[0] + ';' + str(tile_pos[1]))] = {'type': self.tile_list[self.tile_group], 'variant': self.tile_variant, 'pos': (mpos[0] + self.scroll[0], mpos[1] + self.scroll[1])}
